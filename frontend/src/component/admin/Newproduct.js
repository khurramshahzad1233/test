...
import { createnewproduct, clearerror } from '../../action/productaction';
...
const Newproduct = () => {
    ...
    const {loading,error,success}=useSelector((state)=>state.newadminproductred);
